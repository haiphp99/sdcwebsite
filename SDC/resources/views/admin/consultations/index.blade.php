    ...
    <div class="card">
        ...
        <div class="card-body container-fluid pt-4 px-4">
            <div class="row g-4">
                ...
                <div
                    class="box-search-consulTable pull-right d-inline-block justify-content-between mt-3 searchConsultation">
                    {!! Form::open([
                    ...
                    <div class="select_course">
                        <select name="course" id="course" class="form-control bg-white search-selecte-category select_course">
                            <option value="">{{ __('consultations.course') }}</option>
                            @foreach ($courses as $course)
                                <option {{ isset($_GET['course']) && $_GET['course'] == $course->id ? 'selected' : ' ' }}
                                    value="{{ $course->id }}">{{ $course->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    <label for=""
                        class="control-label label_consulDate">{{ __('consultations.FromCreated') }}</label>
                    ...
                    <label for=""
                        class="control-label label_consulDate">{{ __('consultations.ToCreated') }}</label>
                            ...
                            @foreach ($consultations as $key => $value)
                                <tr>
                                    ...
                                    <td class="action text-center">
                                        <a href="javascript:;" title="{{ trans('common.view') }}"
                                            class="btn btn-primary mr-2" data-toggle="modal"
                                            data-target="#View_{{ $value->id }}"><i class="fa fa-eye"
                                                aria-hidden="true"></i>
                                        </a>
                                        <a href="javascript:;"
